function Mocap_visualize(t, o, quat, moviefile)
%
%   t           time (1xM)
%   o           position of body frame in coordinates of room frame (3xM)
%   quat        Quaternion of model.
...
while (1)
    ...
    [pQuad_InRoom, pBodyFrame_InRoom] = ...
        UpdateGeometry(t(i), o(:, i), quat(i,:), ... % hy(i), hp(i), hr(i), ...
                       pQuad_InBody, pBodyFrame_InBody);
    
    % Update figure
    fig = UpdateFigure(fig, t(i), o(:, i), ...
...
function [pQuad_InRoom, pBodyFrame_InRoom] = ...
    UpdateGeometry(t, o, quat, pQuad_InBody, pBodyFrame_InBody)
...
pQuad_InRoom = pQuad_InBody;
pBodyFrame_InRoom = pBodyFrame_InBody;

% rotate and move shits
Rot = quat2dcm(quat);
Rot = Rot(:,[1,3,2]);
pQuad_InRoom = (pQuad_InRoom'*Rot)'+ o;
pBodyFrame_InRoom = (pBodyFrame_InRoom'*Rot)' + o;
...
function [fig] = UpdateFigure(fig, t, o, pMocap_InRoom, pQuad_InRoom, fQuad, pRoomFrame_InRoom, pBodyFrame_InRoom)
